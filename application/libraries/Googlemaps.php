...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyA0za7gSm6K-8eFKK-np3jhyyW5IMRVSb8'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function create_map()
	{
		...
		$this->output_js_contents .= '
		  function filterMarkers2(category) {
		  	var awrCheck = document.getElementById("station_cuaca").checked;
			var arrCheck = document.getElementById("arr").checked;
		  	...
		  	var check = document.getElementById(category).checked;
				 ...
				 if(awrCheck == true)
				 {
				 	 var x = document.getElementsByName("station_cuaca");
					    var i;
