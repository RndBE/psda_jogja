...
<div class="page-body">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0 pt-2">
									<?php
									echo form_open('curah_hujan/set_pos'); ?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0 pt-2">
									...
									<?php
									echo form_open('curah_hujan/set_parameter'); ?>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<?php echo form_open('curah_hujan/sesi_data'); ?>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="h3 m-0 pt-2">
										...
										<?php echo form_open('curah_hujan/settgl'); ?>
										<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="h3 m-0 pt-2">
										<?php echo form_open('curah_hujan/setbulan'); ?>
										<div class="row">
											<div class="col-12 col-md-12 col-sm-12">
												<div class="input-icon">
													<input type="month" class="form-control " name="bulan" placeholder="Pilih Bulan" value="" autocomplete="off" required />
													<!--	<span class="input-icon-addon">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="h3 m-0 pt-2">
										<?php echo form_open('curah_hujan/settahun'); ?>
										<div class="row">
											<div class="col-12 col-md-12 col-sm-12">
												<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php } ?>
								<?php if ($this->session->userdata('username') == 'usersdad') { ?>
								
								<button data-bs-toggle="modal" data-bs-target="#upload_csv" class="btn btn-outline-warning w-100 mt-3">
	...
	<div class="modal fade" id="upload_csv" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalToggleLabel">Upload CSV</h5>
			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					...
					<div class="modal-body text-center" id="tw">
						...
						$data_count = count($data20) > 1440 ? 1440 : count($data20);
