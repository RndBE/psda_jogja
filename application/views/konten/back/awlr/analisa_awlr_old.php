...
{ ?>
				   <div class="dropdown">
                        <a href="#" class="btn btn-primary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <circle cx="12" cy="12" r="3"></circle>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                          <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modal-lengkung"> <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
   <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"></path>
   <path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z"></path>
   <path d="M16 5l3 3"></path>
</svg>Lengkung Debit</a>
                         <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modal-siaga" ><svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
   <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"></path>
   <path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z"></path>
   <path d="M16 5l3 3"></path>
                           ...
                           echo form_open('awlr/set_pos');?>
                            <select type="text" name="pilihpos" class="form-select" placeholder="Pilih Pos AWLR" onchange="this.form.submit()" id="select-pos" value=" ">
                              ...
                              <?php foreach($pilih_pos as $mnpos )
                                {
                                    echo '<option value="'.$mnpos->idLogger.'">'.str_replace('_', ' ', $mnpos->namaPos).'</option>';
                                 }
                              ?>
                            </select>
                    <?php echo form_close() ?>
                           ...
                           echo form_open('awlr/set_parameter');?>
                            <select type="text" name="mnsensor" class="form-select" placeholder="Pilih Parameter"  onchange="this.form.submit()"  id="select-parameter" value=" ">
                              ...
                              <?php foreach($pilih_parameter as $mnparameter )
                                {
                                    echo '<option value="'.$mnparameter->idParameter.'">'.str_replace('_', ' ', $mnparameter->namaParameter).'</option>';
                                 }
                              ?>
                            </select>
                            <?php echo form_close() ?>
                                      ...
                                      <div class="card-body">
                                        ...
                                        <div class="h3 m-0">
                                           ...
                                           <div class="row">
                                             <div class="col-12 col-md-12 col-sm-12">
                                            <div class="input-icon">
                                                  <input class="form-control " name="bulan" placeholder="Pilih Bulan" id="dpbulan" value="" autocomplete="off" required/>
                                                  <span class="input-icon-addon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><line x1="11" y1="15" x2="12" y2="15" /><line x1="12" y1="15" x2="12" y2="18" /></svg>
                                                  </span>
                                                </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="input-icon">
												 ...
												 <div class="input-icon">
                                                  ...
                                                  <input class="form-control" name="sampai" placeholder="Sampai" id="dpsampai" value="" autocomplete="off" required/>
                                                  <span class="input-icon-addon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><line x1="11" y1="15" x2="12" y2="15" /><line x1="12" y1="15" x2="12" y2="18" /></svg>
                                                  </span>
                                                </div>
