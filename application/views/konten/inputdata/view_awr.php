<html>
<head>
   <title>Data AWR</title>
</head>
<body>
<h1>Data Input AWR</h1> <?php echo 'ID LOGGER '.$this->session->userdata('log_id').' ##### |'.$this->session->userdata('tgl_awlr').'|'; ?>

<hr/>



<?php echo form_open('datamasuk/sesi_loggerawr');?>
...
<?php      
   foreach($data_awr->result() as $row){
      ?>
     <tr>
